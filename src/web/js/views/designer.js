/* Designer view: hosts the designer app shell (/designer/app) in an iframe.
   ...
   workflow and doubles as its rename affordance (click to edit; the edit
...
function applyMeta() {
  ...
  if (meta) {
    ...
    title.title = meta.editable ? 'Click to rename — commits with “Save to git”' : 'Switch to Canvas to rename';
  } else {
    title.title = '';
  }
